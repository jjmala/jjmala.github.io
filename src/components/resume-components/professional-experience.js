    ...
    <section className='section'>
      ...
      <StyledArticle>
        <h4 className='title is-4 is-uppercase'>
          PROGETTO SUONI e IMMAGINI per L'UCRAINA :: <small className='has-text-weight-light'> Gennaio - in
          corso</small>
        </h4>
      ...
      <StyledArticle>
        ...
        <ul>
          ...
          <li>• Evacuazione da Leopoli e organizzazione dell'accoglienza di nuclei familiari in Italia e paesi UE, Lviv
            UA;
          </li>
